...
int main(int argc, const char **argv) {
	...
	//Gives error about typecasting? Just a IDE issue, not an actual error...
	...
	getLastCudaError("Path calculation execution failed\n");
	...
	//Get averaage on CPU (not parralelizable)
	sum1 = 0.0;
	sum2 = 0.0;
